                ...
                >
                    ...
                    <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-3">
                            <p className="text-base font-medium text-gray-700 group-hover:text-gray-900">{user&&user.email}</p>
                            <p  className="text-sm font-medium text-gray-500 group-hover:text-gray-700">Salir</p>
                            </div>
                        </div>
                        </button>
                    </div>
