...
function BlogCardHorizontal({data,index}){
    const fullImageUrl = `https://res.cloudinary.com/${cloudName}/${data.thumbnail}`;
            ...
            <div className="flex items-center   my-10 ">
              <div className="lg:flex min-w-0 lg:flex-1 items-center">
                <figure className="lg:flex-shrink-0">
                  {
                    data.thumbnail?
                    <img id={index} className="h-64 lg:w-96 w-full object-cover rounded" src={fullImageUrl} alt="" />
                    :
                ...
                <div className="min-w-0 flex-1 px-8 p-4 ">
                  ...
                  <div className="lg:absolute lg:top-28">
                      ...
                      <span className="mt-2 mx-2 font-medium text-gray-800 text-sm">{data.time_read} minutos de lectura</span> 
                      {
                        data.description ?
